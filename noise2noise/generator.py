...
class NoisyImageGenerator(Sequence):
    def __init__(self, image_dir, source_noise_model, target_noise_model, batch_size=32, image_size=64, **kwargs):
...
class ValGenerator(Sequence):
    def __init__(self, image_dir, val_noise_model, **kwargs):
        super().__init__(**kwargs)
        image_suffixes = (".jpeg", ".jpg", ".png", ".bmp")
