...
class N2V(CARE):
    ...
    def prepare_for_training(self, optimizer=None, **kwargs):
        ...
        if optimizer is None:
            from tensorflow.keras.optimizers.legacy import Adam  # TODO : added the .legacy because of M1
    ...
    def prepare_model(self, model, optimizer, loss, metrics=('mse', 'mae')):
        ...
        from tensorflow.keras.optimizers.legacy import Optimizer # TODO : added the .legacy because of M1
